...
echo json_encode([
    ...
    'encuesta_url' => $url,
    'nivel' => ucfirst($nivel),
    'advertencia' => (strpos($url, 'localhost') !== false || strpos($url, '127.0.0.1') !== false) 
        ? 'ATENCIÓN: Estás usando localhost. Este QR NO funcionará en dispositivos externos. Configura tu dominio público en el archivo generar.php' 
        : null
