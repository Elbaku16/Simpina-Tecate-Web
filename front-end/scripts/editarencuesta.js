...
const API_OBTENER = `${window.BASE_URL}/back-end/routes/encuestas/obtener_editar.php?nivel=${encodeURIComponent(NIVEL)}`;
const API_GUARDAR = `${window.BASE_URL}/back-end/routes/encuestas/guardar.php`;
