...
<head>
  ...
  <link rel="stylesheet" href="/front-end/assets/css/global/overrides_encuesta.css">
</head>
<body>
  ...
  <div class="survey-selection__wrapper">
    ...
    <ul class="grade-grid">
      <li class="grade-item preescolar">
        ...
        <h3>Preescolar</h3>
        <a href="/front-end/frames/encuestas/demo-encuestas.php?nivel=preescolar" class="btn-nivel nivel--green">Comenzar</a>
      </li>

      <li class="grade-item primaria">
        <img src="/front-end/assets/img/escolaridad/primaria.png" alt="Primaria">
        <h3>Primaria</h3>
        <a href="/front-end/frames/encuestas/demo-encuestas.php?nivel=primaria" class="btn-nivel nivel--blue">Comenzar</a>
      </li>

      <li class="grade-item secundaria">
        <img src="/front-end/assets/img/escolaridad/secundaria.png" alt="Secundaria">
        <h3>Secundaria</h3>
        <a href="/front-end/frames/encuestas/demo-encuestas.php?nivel=secundaria" class="btn-nivel nivel--red">Comenzar</a>
      </li>

      <li class="grade-item preparatoria">
        <img src="/front-end/assets/img/escolaridad/preparatoria.png" alt="Preparatoria">
        <h3>Preparatoria</h3>
        <a href="/front-end/frames/encuestas/demo-encuestas.php?nivel=preparatoria" class="btn-nivel nivel--magenta">Comenzar</a>
      </li>
    </ul>
  </div>
</section>
