    ...
    <main>
        <section class="hero-section">
            <div class="hero-content">
                <div class="hero-left">
                    <img src="/SIMPINNA/front-end/assets/img/inicio/ninos.png?v=1" alt="Niños felices" class="hero-image">
                    <p class="hero-text">
                        Protegiendo los derechos y el bienestar de las niñas,
                        niños y adolescentes de Tecate, con acciones que
                ...
                <div class="hero-right">
                    <div class="encuesta-card">
                        ...
                        <a href="/SIMPINNA/front-end/pages/encuesta.php" class="btn-encuesta">Encuesta</a>
                    </div>
                </div>
            </div>
        </section>
